...
class Advance extends BaseController
{
    ...
    public function viewPublic()
    {
        ...
        $dataprojekmodel = new \App\Models\DataProjekModel();
        $projek = $dataprojekmodel->where('token', $API)->first();
        return view('advance/public', [
            'projek' => $projek,
        ]);
    }
    //--------------------------------------------------------------------
