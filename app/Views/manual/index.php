...
#carbonads a{color:#fff;text-decoration:none}#carbonads a:hover{color:#fff}
    ...
    <div class="masthead-bg"> <?= $this->include('layout/navbar'); ?></div>
        <div id="momoland">
            <div class="wrapper">
                        <h1>Default Projek</h1>
                        <div class="container">
                            <h3>Buat Projek Kendali dan Monitoring dengan mudah di sini, klik Dokumentasi untuk jika ada kesulitan dalam menggunakannya, klik creat new projek untuk membuat projek baru, dan klik About template untuk memberikan masukan , saran dab bugs yang anda alami agar dapat ditingkatkan lagi kedepannya</h3>
                        </div>
